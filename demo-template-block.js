 ...
 */
class DemoTemplateBlock extends React.Component {
  constructor (props) {
  ...
  render() {
    ...
    return React.createElement("div", null, React.createElement("label", {
        for: "attr"
    }, "Min attribut:"), React.createElement("br", null), React.createElement("input", {
        value: this.props.attributes.min_attribut,
        onChange: this.updateMinAttribut,
        name: "min_attribut",
        id: "attr"
   ...
   */
  updateMinAttribut = (event) => {
    // Uppdatera attributen som ska skickas till servern.
    this.props.setAttributes({ min_attribut: event.target.value })
  }
...
wp.blocks.registerBlockType('demo-template/block' /* "Computer readable" unika namnet. */, {
  title: 'Demo Template Block', // "Human readable" Namnet på blocket
  ...
  edit: function (props) {
    ...
    return React.createElement(DemoTemplateBlock, props, null)
  },
  /**
